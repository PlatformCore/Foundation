...
type enterpriseContextKey struct{}
...
func NewEnterprise(opts Options) *EnterpriseLogger {
	l := &EnterpriseLogger{
...
func DefaultEnterprise() *EnterpriseLogger {
	return NewEnterprise(Options{
		Level:     LevelInfo,
...
func (l *EnterpriseLogger) SetLevel(lvl Level) {
	l.level.Store(int32(lvl))
}

// GetLevel returns the current log level.
func (l *EnterpriseLogger) GetLevel() Level {
	return Level(l.level.Load())
}

// With returns a child logger with additional persistent fields.
func (l *EnterpriseLogger) With(fields ...Field) *EnterpriseLogger {
	child := &Logger{
...
func (l *EnterpriseLogger) WithContext(ctx context.Context) *EnterpriseLogger {
	child := l.With()
	if rid, ok := ctx.Value(enterpriseContextKey{}).(string); ok && rid != "" {
...
func ContextWithRequestID(ctx context.Context, requestID string) context.Context {
	return context.WithValue(ctx, enterpriseContextKey{}, requestID)
}

func (l *EnterpriseLogger) log(lvl Level, msg string, fields []Field) {
...
func (l *EnterpriseLogger) Debug(msg string, fields ...Field) { l.log(LevelDebug, msg, fields) }
func (l *EnterpriseLogger) Info(msg string, fields ...Field)  { l.log(LevelInfo, msg, fields) }
func (l *EnterpriseLogger) Warn(msg string, fields ...Field)  { l.log(LevelWarn, msg, fields) }
func (l *EnterpriseLogger) Error(msg string, fields ...Field) { l.log(LevelError, msg, fields) }
func (l *EnterpriseLogger) Fatal(msg string, fields ...Field) { l.log(LevelFatal, msg, fields) }

// Debugf logs a debug message with fmt.Sprintf formatting.
func (l *EnterpriseLogger) Debugf(format string, args ...interface{}) {
	l.log(LevelDebug, fmt.Sprintf(format, args...), nil)
}

// Infof logs an info message with fmt.Sprintf formatting.
func (l *EnterpriseLogger) Infof(format string, args ...interface{}) {
	l.log(LevelInfo, fmt.Sprintf(format, args...), nil)
}

// Warnf logs a warn message with fmt.Sprintf formatting.
func (l *EnterpriseLogger) Warnf(format string, args ...interface{}) {
	l.log(LevelWarn, fmt.Sprintf(format, args...), nil)
}

// Errorf logs an error message with fmt.Sprintf formatting.
func (l *EnterpriseLogger) Errorf(format string, args ...interface{}) {
	l.log(LevelError, fmt.Sprintf(format, args...), nil)
}

// Fatalf logs a fatal message and exits the process.
func (l *EnterpriseLogger) Fatalf(format string, args ...interface{}) {
